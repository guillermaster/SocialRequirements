...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="RequirementsListGrid" ItemType="SocialRequirements.Domain.DTO.Requirement.RequirementModificationDto" 
    ...
    <asp:Panel runat="server" ID="RequirementsRepeaterPanel">
        <asp:Repeater ID="RequirementsListRepeater"
            ItemType="SocialRequirements.Domain.DTO.Requirement.RequirementModificationDto" runat="server" 
            ...
            <ItemTemplate>
                <div class="smallcard">
                    <div class="smallcard_title" style="cursor: pointer"
                        onclick="javascript:location.href='<%# SocialRequirements.Domain.General.CommonConstants.FormsFileName.RequirementModification %>?<%# SocialRequirements.Domain.General.CommonConstants.QueryStringParams.CompanyId %>=<%# Eval("CompanyId") %>&amp;<%# SocialRequirements.Domain.General.CommonConstants.QueryStringParams.ProjectId %>=<%# Eval("ProjectId") %>&amp;<%# SocialRequirements.Domain.General.CommonConstants.QueryStringParams.RequirementId %>=<%# Eval("RequirementId") %>&amp;<%# SocialRequirements.Domain.General.CommonConstants.QueryStringParams.Id %>=<%# Eval("ID") %>'">
                        <h5><%# Eval("Title") %></h5>
                    </div>
