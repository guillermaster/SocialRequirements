    ...
    public partial class Register : SocialRequirementsPublicPage
    {
        ...
        private void CreateUser()
        {
            try
            {
                ...
                var personResponse = personService.CreateNewUser(Name.Text, Lastname.Text, encPrimaryemail,
                    encSecondaryemail,
            ...
            {
                SetErrorMessage("An unknown error has occurred");
                ViewExceptionButtonLink.Visible = true;
                ExceptionMessage.Text = ex.InnerException != null ? ex.InnerException.Message : ex.Message;
            }
        }
        #endregion
